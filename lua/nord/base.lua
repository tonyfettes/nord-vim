...
local base_group = lush(function ()
  return {
    ...
    CursorLine { fg = empty, bg = nord1, gui = NONE, },
    ...
    Pmenu { fg = nord4, bg = nord2, gui = NONE, },
    ...
    CursorLineNr { fg = nord4, bg = cursor_line_nr_bg, gui = NONE, },
    ...
    StatusLine { fg = nord8, bg = nord3, gui = NONE },
    StatusLineNC { fg = nord4, bg = statue_line_nc_bg, gui = NONE },
    StatusLineTerm { fg = nord8, bg = nord3, gui = NONE },
    StatusLineTermNC { fg = nord4, bg = statue_line_term_nc_bg, gui = NONE },
    WarningMsg { fg = nord0, bg = nord13 },
    WildMenu { fg = nord8, bg = nord1  },

    -- Search --
    IncSearch { fg = nord6, bg = nord10, gui = styles.underline },
    Search { fg = nord1, bg = nord8, gui = NONE, },

    -- Tabs --
    TabLine { fg = nord4, bg = nord1, gui = NONE, },
    TabLineFill { fg = nord4, bg = nord1, gui = NONE, },
    TabLineSel { fg = nord8, bg = nord3, gui = NONE, },

    -- Window --
    Title { fg = nord4, bg = empty, gui = NONE, },
  }
end)
